...
<!-- 최상위 디렉토리 mysite 이후 WebContent 안쪽부터 시작이다. 인터넷 주소이므로 폴더 이름X-->
<!-- ↓인터넷에서의 주소 / web modules의 path 이름이 모듈의 인터넷 주소 이름이다  -->
				...
				<div id="index">
					...
					<div id="greetings">
						<p class="text-xlarge">
							...
							<br> (자유롭게 꾸며보세요!!)<br> <br>
							<br> <a class="" href="/mysite/guest?action=addList">[방명록에
								글 남기기]</a>
						</p>
					</div>
					<!-- //greetings -->
